...
namespace TrucoServer.Helpers.Match
{
    public interface ILobbyCoordinator
    {
        ...
        List<PlayerInformation> GetGuestPlayersFromMemory(string matchCode, string ownerUsername = null);
        PlayerInformation GetPlayerInfoFromCallback(Contracts.ITrucoCallback callback);
        ...
        void AddMatchCallbackMapping(Contracts.ITrucoCallback callback, PlayerInformation info);
